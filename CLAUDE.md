...
| Suites | **2148** tests · **199** adversarial · 44 end-to-end |
...
python -m pytest tests/ -q   # 2148 tests, ~30s
python redteam.py            # 199 adversarial cases — mandatory for any kernel change
