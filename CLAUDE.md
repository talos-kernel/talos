...
| Suites | **2088** tests · **185** adversarial · 44 end-to-end |
...
python -m pytest tests/ -q   # 2088 tests, ~30s
python redteam.py            # 185 adversarial cases — mandatory for any kernel change
