...
| Suites | **2099** tests · **186** adversarial · 44 end-to-end |
...
python -m pytest tests/ -q   # 2099 tests, ~30s
python redteam.py            # 186 adversarial cases — mandatory for any kernel change
