...
<p align="center">
  <!-- ⚠️ Bewusst „tests", nicht „passing": die Zahl kommt aus dem Einsammeln (2065).
  ...
  <img src="https://img.shields.io/badge/tests-2065-2e7d32.svg" alt="Tests">
...
python -m pytest tests/ -q               # 2065 tests
