...
<p align="center">
  <!-- ⚠️ Bewusst „tests", nicht „passing": die Zahl kommt aus dem Einsammeln (1890).
  ...
  <img src="https://img.shields.io/badge/tests-1890-2e7d32.svg" alt="Tests">
...
python -m pytest tests/ -q               # 1890 tests
