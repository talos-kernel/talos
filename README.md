...
<p align="center">
  <!-- ⚠️ Bewusst „tests", nicht „passing": die Zahl kommt aus dem Einsammeln (1737).
  ...
  <img src="https://img.shields.io/badge/tests-1737-2e7d32.svg" alt="Tests">
  <img src="https://img.shields.io/badge/red%20team-166%2F166-2e7d32.svg" alt="Red team">
  <img src="https://img.shields.io/badge/gate%20path-548%20lines-8a4318.svg" alt="Gate path">
...
python -m pytest tests/ -q               # 1737 tests
...
Small modules on purpose. The gate path (`policy.py`, 548 lines) has to be readable in one
